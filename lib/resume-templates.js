...
<body>
  ...
  <div class="contact">${s.contact || 'email@example.com | (555) 555-5555 | linkedin.com/in/you | github.com/you'}</div>
...
<body>
  <div class="name">${s.name || 'Your Name'}</div>
  <div class="contact">${s.contact || 'email@example.com | linkedin.com/in/you | github.com/you'}</div>
...
<body>
  <div class="name">${s.name || 'Your Name'}</div>
  <div class="contact">${s.contact || 'email • phone • linkedin • github'}</div>
